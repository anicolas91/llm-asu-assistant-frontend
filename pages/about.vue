...
import AboutImage from '@/assets/img/manguito.jpeg'

useHead({
  title: 'ABOUT | ASU LLM Assistant',
  meta: [
    {
      property: 'og:title',
      content: 'ABOUT | ASU LLM Assistant',
    },
  ],
})
</script>
...
<template>
  <div
    class="px-xs py-md flex justify-center items-center min-h-[calc(100vh-77px)] lg:min-h-[calc(100vh-75px)]"
  >
    <div class="p-md md:px-lg md:py-xl bg-dark-3 rounded-md drop-shadow-md">
      <div class="flex flex-col md:flex-row gap-lg items-center justify-center">
        ...
        <div class="text-light-3">
          <h2 class="h2-md mb-xs">ASU LLM Assistant</h2>
